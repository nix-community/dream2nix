...
- [👉 example repository using flakes](https://github.com/nix-community/dream2nix/tree/main/examples/dream2nix-repo-flake)
- [👉 example packages](https://github.com/nix-community/dream2nix/tree/main/examples/packages)
  ...
  - [👉 multi-language](https://github.com/nix-community/dream2nix/tree/main/examples/packages/multi-language)
